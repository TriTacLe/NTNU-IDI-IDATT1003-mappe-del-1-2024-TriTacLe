...
void testAddDuplicateItem() {
  ...
  foodStorage.addItem(apple1);
  foodStorage.addItem(apple2);
...
void testTotalValue() {
  ...
  foodStorage.addItem(rice);
  foodStorage.addItem(wheat);
